...
const addressData = [
  {
    icon: faLocationDot,
    title: "Address",
    description: "49 & 51, Jalan Dagangan 10, Pusat Bandar Bertam Perdana, 13200 Kepala Batas, Pulau Pinang",
  },
  {
    icon: faEnvelope,
    title: "My Email",
    description: "hoteljannah@gmail.com",
  },
  {
    icon: faPhone,
    title: "Call Me Now",
    description: "019-799 9935",
  },
];
